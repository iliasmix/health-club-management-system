...
public class TrainingPlan {
    ...
    // Constructors
    public TrainingPlan(String coachId, LocalDate startDate, int weeksnum, String exercise) {
    ...
    public TrainingPlan(String coachId, LocalDate startDate, int weeksnum, ArrayList<String> exercise) {
        this.scheduleId = generateScheduleId(); // Auto-increment Schedule ID
        ...
        for(int i=0; i<exercise.size(); i++) {
            this.exercises.add(exercise.get(i));
        }
    }
